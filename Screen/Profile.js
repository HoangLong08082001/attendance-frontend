...
const Profile = (props) => {
  ...
  const [name, setName] = useState(userInfo.name); // Lấy tên hiện tại từ userInfo trong context
  //const [slogan, setSlogan] = useState(userInfo.slogan);
  ...
  const images = [
    {
      // url: avatar
      // ? `data:image/gif;base64,${avatar}`  // Chỉ truyền chuỗi URL (uri) trực tiếp
      // : require("../assets/avatar/user_default.png"),  // Sử dụng chuỗi đường dẫn tới ảnh mặc định
      url: userInfo?.avatar
        ? avatar
              ...
              <TouchableWithoutFeedback onPress={handleCloseModal}>
                ...
                >
                  <ImageViewer
                    ...
                    renderIndicator={() => null} // Ẩn chỉ báo trang
                  />
                  <TouchableWithoutFeedback onPress={handleCloseModal}>
                    <View
                      style={{
