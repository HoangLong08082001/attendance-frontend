...
const EarlyLeaveScreen = (props) => {
  ...
  const [toTime, setToTime] = useState(getHoursFromSetting(checkout_setting));
  const [showFromTimePicker, setShowFromTimePicker] = useState(false);
  const [showToTimePicker, setShowToTimePicker] = useState(false);
  const [fromMinute, setFromMinute] = useState(null);
  const [toMinute, setToMinute] = useState(
    getMinutesFromSetting(checkout_setting)
  );
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <Text allowFontScaling={false} style={styles.headerText}>
              Tạo mới Đơn xin về sớm (Không tính lương)
            </Text>
            ...
            <View>
              ...
              <View style={styles.wrap}>
                ...
                <View style={styles.sub_wrap}>
                  ...
                  >
                    <Text allowFontScaling={false}>
                      {toTime && toMinute ? toTime + ":" + toMinute : "17:00"}
                    </Text>
                    <AntDesign name="clockcircleo" size={24} color="black" />
                  </TouchableOpacity>
                </View>
...
export default EarlyLeaveScreen;
